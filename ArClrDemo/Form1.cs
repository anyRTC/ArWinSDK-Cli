...
namespace ArClrDemo
{
    ...
    {
        private ArtcClr artc = new ArtcClr();
        private ArtcClrLibrary.onCameraReady cameraReadyEvent;
        ...
        private bool onCaptureVideoFrame(ArtcClrLibrary.ClrVideoFrame frame)
        {
            return true;
        }
