...
namespace ArtcCliLibrary {
	...
	typedef void(__stdcall * PFOnAudioVolumeIndication)(const ar::rtc::AudioVolumeInfo* speakers, unsigned int speakerNumber, int totalVolume);
	typedef void(__stdcall * PFOnLeaveChannel)(const ar::rtc::RtcStats& stats);
	typedef void(__stdcall * PFOnRtcStats)(const ar::rtc::RtcStats& stats);
	...
	typedef void(__stdcall * PFOnLocalVideoStats)(const ar::rtc::LocalVideoStats& stats);
	typedef void(__stdcall * PFOnRemoteVideoStats)(const ar::rtc::RemoteVideoStats& stats);
	...
	delegate void NativeOnAudioVolumeIndicationDelegate(const ar::rtc::AudioVolumeInfo* speakers, unsigned int speakerNumber, int totalVolume);
	delegate void NativeOnLeaveChannelDelegate(const ar::rtc::RtcStats& stats);
	delegate void NativeOnRtcStatsDelegate(const ar::rtc::RtcStats& stats);
	...
	delegate void NativeOnLocalVideoStatsDelegate(const ar::rtc::LocalVideoStats& stats);
	delegate void NativeOnRemoteVideoStatsDelegate(const ar::rtc::RemoteVideoStats& stats);
	...
	public class ArtcCliEventHandler : public ar::rtc::IRtcEngineEventHandler
	{
	public:
		ArtcCliEventHandler();
		~ArtcCliEventHandler();
		...
		void onAudioVolumeIndication(const ar::rtc::AudioVolumeInfo* speakers, unsigned int speakerNumber, int totalVolume) override;
		void onLeaveChannel(const ar::rtc::RtcStats& stats) override;
		void onRtcStats(const ar::rtc::RtcStats& stats) override;
		...
		void onLocalVideoStats(const ar::rtc::LocalVideoStats& stats) override;
		void onRemoteVideoStats(const ar::rtc::RemoteVideoStats& stats) override;
