...
namespace ArtcCliLibrary {
	...
	{
		/** 0: The SDK is connecting to Artc's edge server. */
		CONNECTION_CHANGED_CONNECTING = 0,
		/** 1: The SDK has joined the channel successfully. */
		CONNECTION_CHANGED_JOIN_SUCCESS = 1,
		/** 2: The connection between the SDK and Artc's edge server is interrupted. */
		CONNECTION_CHANGED_INTERRUPTED = 2,
		/** 3: The connection between the SDK and Artc's edge server is banned by Artc's edge server. */
	   ...
	   */
	   ...
	   /** 14: Timeout for the keep-alive of the connection between the SDK and Artc's edge server. The connection state changes to CONNECTION_STATE_RECONNECTING(4). */
...
*/
					 ...
					 */
					  ...
					  */
					   ...
					   */
						...
						* To achieve better virtual stereo reverberation, Artc recommends setting `profile` in `setAudioProfile`
	...
	public enum class EnumRtmpStreamPublishError {
		...
		/** An error occurs in Artc's streaming server. Call the addPublishStreamUrl method to publish the streaming again. */
		...
		/** Artc's server fails to find the RTMP streaming. */
 ...
 */
  ...
  */
	...
	public enum class EnumVoiceBeautifierPreset
	{
		 ...
		 *
		 * @note Artc recommends using this enumerator to process a male-sounding voice; otherwise, you may experience vocal distortion.
		 */
		 CHAT_BEAUTIFIER_MAGNETIC = 0x01010100,
		 /** A fresher voice.
		  *
		  * @note Artc recommends using this enumerator to process a female-sounding voice; otherwise, you may experience vocal distortion.
		  */
		   ...
		   */
			...
			* effect that sounds like singing in a small room. Artc recommends not using \ref IRtcEngine::setVoiceBeautifierPreset "setVoiceBeautifierPreset" (SINGING_BEAUTIFIER)
	...
	public enum class EnumAudioEffectPreset
	{
		 ...
		 *
		 * @note To achieve better audio effect quality, Artc recommends calling \ref IRtcEngine::setAudioProfile "setAudioProfile"
			  ...
			  */
			   ...
			   */
				...
				*/
				 ...
				 *
				 * @note
				 * - Artc recommends using this enumerator to process a male-sounding voice; otherwise, you may not hear the anticipated voice effect.
				 * - To achieve better audio effect quality, Artc recommends calling \ref IRtcEngine::setAudioProfile "setAudioProfile" and
				 ...
				 */
				  ...
				  * @note
				  * - Artc recommends using this enumerator to process a male-sounding voice; otherwise, you may not hear the anticipated voice effect.
				  * - To achieve better audio effect quality, Artc recommends calling \ref IRtcEngine::setAudioProfile "setAudioProfile" and setting
				  ...
				  */
				   ...
				   */
					...
					*
					* @note
					* - Artc recommends using this enumerator to process a female-sounding voice; otherwise, you may not hear the anticipated voice effect.
					* - To achieve better audio effect quality, Artc recommends calling \ref IRtcEngine::setAudioProfile "setAudioProfile" and setting
					* the `profile` parameter to `AUDIO_PROFILE_MUSIC_HIGH_QUALITY(4)` or `AUDIO_PROFILE_MUSIC_HIGH_QUALITY_STEREO(5)` before
					* setting this enumerator.
					*/
					 ...
					 */
					  ...
					  *
					  * @note To achieve better audio effect quality, Artc recommends calling \ref IRtcEngine::setAudioProfile "setAudioProfile" and
					  * setting the `profile` parameter to `AUDIO_PROFILE_MUSIC_HIGH_QUALITY(4)` or `AUDIO_PROFILE_MUSIC_HIGH_QUALITY_STEREO(5)` before
					  * setting this enumerator.
					  */
